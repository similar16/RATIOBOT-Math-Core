...
checks={
 ...
 'teacher reset button':'id="teacherResetBtn"',
 'teacher reset request':'resetPasswordForEmail',
 'teacher recovery event':'PASSWORD_RECOVERY',
 'teacher recovery save':'id="teacherRecoverySaveBtn"',
 'teacher password update':'updateUser({password:a})',
