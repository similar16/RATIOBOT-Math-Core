...
function cleanOcrText(value){return String(value||'').replace(/\u3000/g,' ').replace(/\r/g,'').split('\n').map(line=>{
...
window.QuestionImport={parse,readXml,docx,ocr,imageData,cleanOcrText};
})();